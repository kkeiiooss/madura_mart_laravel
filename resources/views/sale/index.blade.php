                                    ...
                                    @foreach ($datas as $nmr => $data)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <a href="{{ route('sale.edit', $data->id) }}" class="text-secondary font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit item">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form action="{{ route('sale.destroy', $data->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure?')">
                                                    @csrf
                                                    @method('DELETE')
