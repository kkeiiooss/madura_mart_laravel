        ...
        <div class="col-12">
          <div class="card mb-4">
            ...
            <div class="card-body px-0 pt-0 pb-2">
                <form action="{{ route('client.update', $data->id)}}" method="POST" id="form">
                    @csrf
                    @method('PUT')
                    <div class="row ms-3 me-3">
                        <div class="col-12">
                            ...
                            <div class="mb-3 px-3 pt-3">
                                ...
                                <textarea type="text" class="form-control" id="alamat_pelanggan" name="alamat_pelanggan" rows="5" required>{{$data->alamat_pelanggan}}</textarea>
                            </div>
                            <div class="mb-3 px-3 pt-3">
